...
from intric.deep_research.api.deep_research_router import router as deep_research_router
...
router.include_router(deep_research_router, prefix="/research", tags=["deep-research"])
